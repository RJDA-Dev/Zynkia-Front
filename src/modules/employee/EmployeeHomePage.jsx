  ...
  return (
    <>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-4">
        ...
        <div>
          <h3 className="text-sm font-semibold text-gray-400 uppercase tracking-wider mb-3 px-1">{es ? 'Acciones Rapidas' : 'Quick Actions'}</h3>
          <div className="grid grid-cols-2 gap-2">
            {[
              { icon: 'assignment_turned_in', label: es ? 'Permiso' : 'Leave', bg: 'bg-purple-50 text-purple-600', to: '/employee/requests' },
              { icon: 'medical_services', label: es ? 'Medica' : 'Medical', bg: 'bg-red-50 text-red-600', to: '/employee/requests' },
